...
const Footer = () => <footer className="bg-[var(--primary-color)] text-white py-16">
<div className="max-w-7xl mx-auto px-4 md:px-8">
  <div className="grid md:grid-cols-4 gap-8">
    {/* Company Info */}
    <div>
      <h3 className="text-2xl font-bold mb-4 text-[var(--secondary-color-light)]">BanglaBriz</h3>
    ...
    <div>
      ...
      <ul className="space-y-2 text-[var(--gray-color)]">
        <li>
          <a href="#" className="hover:text-[var(--secondary-color-light)] transition-colors">
            Career Guidance
          </a>
        </li>
        <li>
    ...
    <div>
      ...
      <div className="flex mb-4">
        <input
          ...
          className="flex-1 px-4 py-2 rounded-l-lg text-[var(--body-color)] focus:outline-none focus:ring-2 focus:ring-[var(--secondary-color)]"
        />
  ...
  <div className="border-t border-gray-700 mt-12 pt-8 text-center text-[var(--gray-color)]">
    <p>&copy; 2024 BanglaBriz. All rights reserved.</p>
  </div>
</div>
</footer>;
